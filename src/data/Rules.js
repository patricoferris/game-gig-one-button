const rules = {
  ...
  bullet: true,
  content: [
    "Also respect and look after the Intel Lab, Lecture Rooms and the Computer Lab. Note that food or drink may NOT be consumed in Intel Lab or the Lecture Rooms, and we will be checking!",
    ...
    {name: "Be kind and considerate to your fellow hackers and our volunteers. We're all here to have fun! By participating in the hackathon, you agree to abide by the code of conduct.", link: "https://hackcodeofconduct.org/"}
  ]
}
